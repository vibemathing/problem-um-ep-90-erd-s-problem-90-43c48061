...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-90-erd-s-problem-90-43c48061-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-90"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-90-erd-s-problem-90-43c48061-v1",
      "problem_contract_sha256": "a26301215c433edb882eff32a1cd974eb57e0c01b23e5f973d4bf0c218e9eaba",
      "problem_id": "problem:um-ep-90-erd-s-problem-90-43c48061",
      "route_id": "route:um-ep-90-erd-s-problem-90-43c48061-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-90-erd-s-problem-90-43c48061-source-fidelity-01",
      "graph_id": "graph:um-ep-90-erd-s-problem-90-43c48061-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-90-erd-s-problem-90-43c48061-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-90-erd-s-problem-90-43c48061-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every set of $n$ distinct points in $\\mathbb{R}^2$ contain at most $n^{1+O(1/\\log\\log n)}$ many pairs which are distance 1 apart?"
          },
          "statement_sha256": "822a7c3a49043261fa308d4b3f46a1df44961195c3ea03e1da63193c6d831de5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-90-erd-s-problem-90-43c48061-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-90-erd-s-problem-90-43c48061-root",
      "route_id": "route:um-ep-90-erd-s-problem-90-43c48061-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-90-8ebac535226f",
        "url": "https://www.unsolvedmath.com/problems/EP-90"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
